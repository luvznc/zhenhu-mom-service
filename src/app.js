...
function showLoadingThenMatch() {
  ...
  mask.innerHTML = `
    <div class="loader-card">
      ...
      <h3>AI正在匹配</h3>
      <p>正在计算平台等级、母婴专项、含餐认证、IoT记录、距离、排班稳定性与历史质量权重。</p>
    </div>
  `;
...
if (requestedScreen && document.querySelector(`#screen-${requestedScreen}`)) showScreen(requestedScreen);
